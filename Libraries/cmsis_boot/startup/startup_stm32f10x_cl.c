 ...
 * @version   V1.0
 * @date      3/7/2011
 * @brief     STM32F10x Connectivity line Devices Startup code.
...
{       
  /*----------Core Exceptions-------------------------------------------------*/
  (intfunc)((unsigned long)&pulStack[STACK_SIZE-1]),     /*!< The initial stack pointer         */
  ...
  (intfunc)0xF108F85F            /*!< Boot in RAM mode                         */
